...
import { doComment, doCommentNew } from "../../redux/post/post.actions";

const CommentNew = ({ currentPost }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isLoggedIn) {
      ...
      dispatch(
        doCommentNew(data, currentPost.postId, currentPost.postData.comment)
      );
      setComment("");
    } else {
